const i18n = {
  es: {
    ...
    "hero.subtitle": "En Acrovane creamos nuestros propios productos con creatividad e innovación — Zenith es solo el inicio — y financiamos ese camino con páginas web y CRMs a medida para tu negocio.",
    ...
    "services.sub": "Financiamos nuestros productos propios construyendo tecnología a la medida de tu negocio.",
    ...
    "about.sub": "Creemos que la creatividad y la innovación nacen cuando haces lo que disfrutas. Así trabajamos en nuestros proyectos propios… y así trabajamos en los tuyos.",
  ...
  en: {
    ...
    "hero.subtitle": "At Acrovane we craft our own products with creativity and innovation — Zenith is just the start — and we fund that journey by building custom websites and CRMs for your business.",
    ...
    "services.sub": "We fund our own products by building technology tailored to your business.",
    ...
    "about.sub": "We believe creativity and innovation come from doing what you enjoy. That's how we work on our own products… and that's how we work on yours.",
